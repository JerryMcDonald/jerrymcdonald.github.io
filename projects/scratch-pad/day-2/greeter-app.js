...
/*
    Develop: A function that takes one parameter ( the hour of the day )
    Return:  Print a greeting based on the given hour.
*/

function greeter(hour) {
    // if, else-if statement to find out what code
    // block to run. 
    //
    // using the && logical operator we can have to 
    ...
    if( hour >= 0 && hour < 12 ){
        ...
        // if the hour parameter makes it through the if, else-if
        // chain we consider it to be hour 22-24
